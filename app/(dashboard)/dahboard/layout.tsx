...
const items: MenuItem[] = [
  {
    ...
    label: <Link href="/dahboard">Dashboard</Link>,
  },
  {
    key: "2",
    icon: <VerifiedOutlined />,
    label: <Link href="/dahboard/vehicle">Kendaraan</Link>,
  },
  {
    key: "3",
    icon: <VerifiedOutlined />,
    label: <Link href="/dahboard/schedule">Jadwal</Link>,
  },
  {
    key: "4",
    icon: <VerifiedOutlined />,
    label: <Link href="/dahboard/booking">Penyewaan</Link>,
  },
  {
    key: "5",
    icon: <LogoutOutlined />,
    ...
    onClick: () => {
      ...
      window.location.href = "/dahboard/login";
    },
  },
];
...
const Sidebar: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const disableSidebar = ["/dahboard/login", "/dahboard/register"];
