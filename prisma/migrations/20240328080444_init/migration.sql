...
CREATE TABLE `Schedule` (
    ...
    `merchant_id` INTEGER NOT NULL,
    `vehicles_id` INTEGER NULL,
    `start_date` DATETIME(3) NOT NULL,
    `end_date` DATETIME(3) NOT NULL,
    `price` INTEGER NOT NULL,

    UNIQUE INDEX `Schedule_vehicles_id_key`(`vehicles_id`),
...
-- AddForeignKey
ALTER TABLE `Schedule` ADD CONSTRAINT `Schedule_vehicles_id_fkey` FOREIGN KEY (`vehicles_id`) REFERENCES `Vehicle`(`vehicles_id`) ON DELETE SET NULL ON UPDATE CASCADE;
